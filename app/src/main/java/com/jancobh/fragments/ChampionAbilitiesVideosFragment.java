...
public class ChampionAbilitiesVideosFragment extends DialogFragment {
    ...
    public static String EXTRA_PRESSED_KEY_POSITION = "com.jancobh.fragments.extrapressedkeyposition";
    int abilityNumber;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.fragment_champion_abilities_videos);
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_champion_abilities_videos,
                container, false);
        initUI(v);
        progresDialog.show();
        videoView.start();
