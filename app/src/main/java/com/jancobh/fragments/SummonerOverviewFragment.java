...
public class SummonerOverviewFragment extends Fragment implements ResponseListener {
    ...
    public static final String EXTRA_RECENTMATCHES = "com.jancobh.fragments.SummonerOverviewFragment.EXTRA_RECENTMATCHES";
    public static final String EXTRA_SUMMONER_INFO = "com.jancobh.fragments.SummonerOverviewFragment.EXTRA_SUMMONER_INFO";
    public static final String EXTRA_RANKEDSTATS = "com.jancobh.fragments.SummonerOverviewFragment.EXTRA_RANKEDSTATS";
    public static final String EXTRA_LEAGUEINFO = "com.jancobh.fragments.SummonerOverviewFragment.EXTRA_LEAGUEINFO";
    public static final String EXTRA_AVERAGESTATS = "com.jancobh.fragments.SummonerOverviewFragment.EXTRA_AVERAGESTATS";
    ...
    private void initUI(View v) {
        ...
        //header part
        parent = (ScrollView) v.findViewById(R.id.parent);
        FadeInNetworkImageView profileIconIV = (FadeInNetworkImageView) v.findViewById(R.id.profileIconIV);
        TextView summonerNameTV = (TextView) v.findViewById(R.id.summonerNameTV);
        TextView regionLevelTV = (TextView) v.findViewById(R.id.regionLevelTV);

        //averages part
        kdaRL = (RelativeLayout) v.findViewById(R.id.kdaRL);
        kdaRL.setVisibility(View.VISIBLE);
        TextView kdaStatsTV = (TextView) v.findViewById(R.id.kdaStatsTV);
        TextView minionsStatsTV = (TextView) v.findViewById(R.id.minionsStatsTV);
        TextView winRateStatsTV = (TextView) v.findViewById(R.id.winRateStatsTV);
        ...
        if (rankedStatsResponse != null) {
            ...
            if (champions != null && champions.size() > 0) {
                ...
                try {
                    ...
                    kdaTV1.setText((int)Math.round(champions.get(0).getStats().getTotalChampionKills()/(double)(champions.get(0).getStats().getTotalSessionsPlayed()))
                            + "/" + ((int)Math.round(champions.get(0).getStats().getTotalDeathsPerSession()/(double)(champions.get(0).getStats().getTotalSessionsPlayed()))) +
                            "/" + ((int)Math.round(champions.get(0).getStats().getTotalAssists()/(double)(champions.get(0).getStats().getTotalSessionsPlayed()))));
                ...
                try {
                    ...
                    kdaTV2.setText(((int)Math.round(champions.get(1).getStats().getTotalChampionKills()/(double)(champions.get(1).getStats().getTotalSessionsPlayed()))
                            + "/" + ((int)Math.round(champions.get(1).getStats().getTotalDeathsPerSession()/(double)(champions.get(1).getStats().getTotalSessionsPlayed()))) +
                            "/" + ((int)Math.round(champions.get(1).getStats().getTotalAssists()/(double)(champions.get(1).getStats().getTotalSessionsPlayed())))));
                ...
                try {
                    ...
                    kdaTV3.setText(((int)Math.round(champions.get(2).getStats().getTotalChampionKills()/(double)(champions.get(2).getStats().getTotalSessionsPlayed()))
                            + "/" + ((int)Math.round(champions.get(2).getStats().getTotalDeathsPerSession()/(double)(champions.get(2).getStats().getTotalSessionsPlayed()))) +
                            "/" + ((int)Math.round(champions.get(2).getStats().getTotalAssists()/(double)(champions.get(2).getStats().getTotalSessionsPlayed())))));
