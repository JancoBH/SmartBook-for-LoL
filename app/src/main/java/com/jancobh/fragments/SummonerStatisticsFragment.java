...
public class SummonerStatisticsFragment extends Fragment {
    ...
    public static final String EXTRA_STATISTICS = "com.jancobh.fragments.summonerstatisticsfragment.extrastatistics";
    public static final String EXTRA_AVERAGE_STATS = "com.jancobh.fragments.summonerstatisticsfragment.extraaveragestats";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RelativeLayout noRankedRL = (RelativeLayout) v.findViewById(R.id.noRankedRL);
        RelativeLayout rankedStatisticsRL = (RelativeLayout) v.findViewById(R.id.rankedStatisticsRL);
